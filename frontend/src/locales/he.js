...
const he = {
      ...
      requests: {
        heroTitle: 'ספרו לבעלי הנכסים מה',
        heroAccent: 'אתם מחפשים.',
        heroLede: 'פרסמו בקשה אחת מסודרת, ותנו לבעלי נכסים ולבעלי מקצוע להגיע אליכם — במקום לאבד את החיפוש בעשרות קבוצות וואטסאפ.',
        typeAll: 'הכל',
        typeRental: 'דיור',
        typeService: 'שירותים',
        ...
        searchPlaceholder: 'חיפוש — לדוגמה: שלושה חדרים רמת אשכול',
        searchLabel: 'חיפוש בקשות',
        search: 'חיפוש',
        postCta: 'פרסמו בקשה',
        loading: 'טוען בקשות…',
        count: '{{n}} בקשות פתוחות',
        clearAll: 'נקה סינון',
