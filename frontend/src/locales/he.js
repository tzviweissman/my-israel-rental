...
const he = {
      ...
      whyList: {
        ...
        trialNote: '30 הימים הראשונים חינם — אין צורך בכרטיס אשראי כדי להתחיל.',
        ...
        pricingBody: 'ככל שההתחייבות ארוכה יותר, המחיר החודשי נמוך יותר. מתחילים עם 30 יום חינם.',
        faqTitle: 'שאלות',
        faq_billing_q: 'איך עובד החיוב?',
        faq_billing_a: 'החיוב מתבצע מדי חודש בדולרים דרך PayPal, לפי המחיר של תקופת ההתחייבות שבחרתם. 30 הימים הראשונים חינם.',
        faq_cancel_q: 'אפשר לבטל?',
        faq_cancel_a: 'כן. מבטלים מלוח הבקרה ונשארת לכם גישה עד סוף התקופה ששילמתם עליה.',
