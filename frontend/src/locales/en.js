...
const en = {
      ...
      orders: {
        ...
        couriersBody: 'People you trust with a delivery - by name and phone, no account needed. Each gets their own run-sheet link; assign an order to them and send it once.',
        courierName: 'Name',
        courierAdd: 'Add courier',
        courierRemove: 'Remove',
        courierRemoveConfirm: 'Remove {{name}}? Their link stops working and their open deliveries go back to unassigned.',
        ...
        assigned: 'Assigned - send them the run sheet',
        assignedSms: 'Assigned and texted the run sheet',
        sendRunsheet: 'Send run sheet',
        noCouriersYet: 'Add a courier from the toolbar first',
        paid: 'Paid',
        paidShort: 'paid',
