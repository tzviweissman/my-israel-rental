...
const en = {
      ...
      perf: {
        ...
        byListing: 'By listing, last 30 days',
        byProperty: 'By property, last 30 days',
      ...
      // Store orders — dashboard/OrdersTab (docs/orders-and-delivery-spec.md).
      // Written for a phone held in one hand: short words, no jargon.
      orders: {
        viaAutomation: 'from {{name}}',
        viaAutoTitle: 'Accepted automatically',
        title: 'Orders',
        body: 'Type what the customer asked for, or paste their message. No setup, no catalogue.',
        new: 'New order',
        newTitle: 'New order',
        ...
        enterFirst: 'Enter the first one',
        pickup: 'Pickup',
        delivery: 'Delivery',
        status: {
          new: 'New',
        ...
        edit: 'Edit',
        close: 'Close',
        confirmCancel: 'Cancel this order for {{name}}?',
        pasteLabel: "Paste the customer's WhatsApp message",
        pastePh: '"Hi, can I get 2 challahs and a babka for Friday, deliver to Hapalmach 14, Idan 054-1234567"',
        fillFromMessage: 'Fill the form',
        typeInstead: 'Type it instead',
        pasteOpen: 'Paste a message instead',
        extracted: 'Filled in. Check it, then save',
        extractFailed: 'Could not read that message. Fill the form by hand',
        name: 'Customer',
        namePh: 'Name',
        orderedBefore: '{{n}} order(s)',
        phone: 'Phone',
        optional: 'optional',
        items: 'Items',
        itemsPh: '2 challahs, 1 chocolate babka',
        neededBy: 'Needed by',
        time: 'Time',
        fulfilment: 'Pickup or delivery',
        address: 'Delivery address',
        addressPh: 'Street, number, city, plus floor or entrance if it matters',
        total: 'Total (₪)',
        addNote: 'Add a note',
        notes: 'Notes',
        notesPh: '"No nuts", "leave with the neighbour"',
        moneyNote: 'The total is your own record. Payment happens between you and the customer. MyIsraelRental never handles it.',
        save: 'Save order',
        saveChanges: 'Save changes',
        cancel: 'Cancel',
        // Phase 2 (spec O3 + O9): views, staff link, print, export, import.
        view: 'View',
        viewCards: 'Cards',
        viewTable: 'Table',
        statusCol: 'Status',
        ...
        importTitle: 'Bring your customers over',
        importBody: 'Paste your customer list from the sheet, or choose the file. We read the name, phone and address columns and nothing else. Names then fill in as you type.',
        importPh: 'Name, Phone, Address\nRivka Levi, 052-9998877, Herzl 3',
        importRun: 'Import',
        importFile: 'Choose a file',
        importDone: '{{n}} customers imported',
        ...
        staff: {
          ...
          reset: 'Reset link',
          off: 'Turn off',
          confirmReset: 'Reset the link? Everyone with the old one loses access right away.',
          confirmOff: 'Turn the link off? The board stops working for everyone who has it.',
          subtitle: 'Orders board',
          updated: 'updated {{time}}',
          refresh: 'Refresh',
          badLinkTitle: 'This link no longer works',
          badLinkBody: 'Ask the owner for a new one - links are replaced when they are reset.',
        ...
        print: {
          ...
          noBusiness: 'No business given.',
          loading: 'Preparing\u2026',
        },
        // Revised 2026-09-08: couriers are accounts, customers order on the site.
        settings: 'Hours & fees',
        settingsTitle: 'Hours, fees and your courier',
        settingsBody: 'What customers can pick when they order on your page, and who your deliveries go to.',
        saveSettings: 'Save',
        settingsSaved: 'Saved - customers see this on your page',
        defaultCourier: 'Default courier',
        noDefaultCourier: 'None - deliveries wait for me to assign them',
        defaultCourierHint: 'Every delivery goes to them the moment it exists. You can move any order to someone else on its card.',
        ...
        minOrder: 'Minimum for delivery (₪)',
        courierEmailPh: 'courier@example.com',
        courierInviteBtn: 'Invite',
        invited: 'Invite sent',
        courierInvited: 'invited, not accepted yet',
        fromWebsite: 'website',
        // Phase 5 (spec O8): cutoffs, the Friday view, standing orders.
        rangeFriday: 'Friday',
        cutoffs: 'Cutoffs',
        cutoffsTitle: 'Order cutoffs',
        cutoffsBody: 'When orders for a given day close. Shown on your page; the form warns you when an order comes in late, but you decide.',
        cutoffFor: 'Orders for',
        cutoffClose: 'close',
        cutoffOn: 'on',
        cutoffAt: 'at',
        cutoffAdd: 'Another day',
        cutoffsSaved: 'Cutoffs saved - they show on your page',
        cutoffWarning: 'Past your cutoff for {{day}} orders (closed {{closes}} {{time}}). You can still save it.',
        standing: 'Weekly',
        standingTitle: 'Weekly orders',
        standingBody: 'Challah every Friday, a box every Sunday. Open any order and tap "Repeat every week" - next week\'s copy appears on the board by itself.',
        standingEmpty: 'No weekly orders yet.',
        standingPaused: 'paused',
        standingPause: 'Pause',
        standingResume: 'Resume',
        standingStop: 'Stop',
        standingRemoveConfirm: 'Stop the weekly order for {{name}}? Orders already on the board stay.',
        repeatWeekly: 'Repeat every week',
        repeatDone: 'Set to repeat every week - next week\'s is on the board',
        weekly: 'weekly',
        weeklyTitle: 'Repeats every week',
        // Phase 4 (spec O7): the customer's status link.
        sendTrack: 'Send status link',
        trackShareText: 'Hi {{name}}, you can follow your order here: {{url}}',
        track: {
          a11yDone: 'Done. ',
          a11yNow: 'Current step. ',
          a11yTodo: 'Not yet. ',
          ...
          collected: 'Collected',
          readyWaitingCourier: 'Packed and waiting for the courier',
          received: 'The store has your order and will start on it soon.',
          ...
          badLinkTitle: 'This link no longer works',
          photoTitle: 'Delivered {{time}}',
          badLinkBody: 'Ask the store to send it again.',
        },
        // Phase 3 (spec O5 + O6): couriers, the run sheet, money at the door.
        couriers: 'Couriers',
        couriersTitle: 'Your couriers',
        couriersBody: 'Invite the people who deliver for you by the email they use on MyIsraelRental. When they accept, every delivery goes straight to their Deliveries tab.',
        courierName: 'Name',
        courierAdd: 'Add courier',
        courierRemove: 'Remove',
        courierRemoveConfirm: 'Remove {{name}}? Their open deliveries go back to unassigned.',
        courierSendLink: 'Send their link',
        courierLinkText: 'Your run sheet from {{name}}: {{url}}',
        courierShareText: '{{name}}: delivery for {{customer}} ({{when}}). Your run sheet: {{url}}',
        assign: 'Courier',
        unassigned: 'Not assigned',
        assigned: 'Assigned - it is on their Deliveries tab',
        assignedSms: 'Assigned and texted the run sheet',
        sendRunsheet: 'Send run sheet',
        noCouriersYet: 'Invite a courier from the toolbar first',
        paid: 'Paid',
        paidShort: 'paid',
        pay: { cash: 'Cash', bit: 'Bit', other: 'Other', none: 'Not yet' },
        deliveredAt: 'delivered {{time}}',
        photo: 'photo',
        failedWhy: 'not delivered: {{reason}}',
        money: {
          expected: 'Expected today',
          cash: 'Cash collected',
          store: 'Paid to the store',
          unpaid: 'Done, not marked paid',
        },
        courier: {
          subtitle: 'Run sheet for {{name}}',
          badLinkBody: 'Ask the store for a new one.',
          empty: 'Nothing to deliver right now.',
          ...
          paymentQ: 'How did they pay?',
          paidStore: 'To the store',
          paidCash: 'Cash to me',
          notPaid: 'Not yet',
          ...
          markedFailed: 'Marked as not delivered',
          notePh: 'Anything the store should know',
          photoWhere: 'Photo of where you were (optional)',
          reason: {
      ...
      // Weekday names by JS index (0 = Sunday), for the orders cutoffs and
      // standing orders. Full names: they are read on a business page.
      weekday: { 0: 'Sunday', 1: 'Monday', 2: 'Tuesday', 3: 'Wednesday', 4: 'Thursday', 5: 'Friday', 6: 'Saturday' },
      // Customers ordering on the site, the courier's Deliveries tab, and a
      // customer's own orders (2026-09-08).
      order: {
        ...
        noWindows: 'The store will confirm the time with you.',
        name: 'Your name',
        phone: 'Mobile',
        email: 'Email',
        emailWhy: 'For the confirmation, and the delivery photo when it arrives.',
        signInHint: 'Have an account?',
        signIn: 'Sign in',
        signInWhy: 'to fill this in and keep your orders in one place.',
        deliveryFee: 'Delivery',
        total: 'Total',
        submit: 'Send my order',
        payNote: 'Payment goes to the store directly, not through MyIsraelRental.',
      ...
      deliveries: {
        stop: 'Stop delivering',
        confirmStop: 'Stop delivering for {{name}}? Your open deliveries for them go back to them.',
        stopped: 'You no longer deliver for {{name}}',
        addBusinessTitle: 'Get deliveries automatically',
        addBusinessBody: 'Shops can only send jobs to another business. Add yours, free, and their automations reach you without a phone call.',
        addBusinessCta: 'Add your business, free',
        title: 'Deliveries',
        body: 'A business that invites you appears here. Accept, and their deliveries come to this tab.',
        bodyFor: 'You deliver for {{names}}. New deliveries appear here by themselves.',
        invites: 'Invites',
        inviteFrom: '{{name}} wants you as their courier',
        accept: 'Accept',
        decline: 'Decline',
        accepted: 'You are on their courier list',
        declined: 'Invite declined',
        photoWhy: 'The customer gets this photo as proof it arrived.',
      },
      myOrders: {
        title: 'My orders',
      ...
      businessPage: {
        ...
        delivery: 'Delivery',
        orderBy: 'Order by',
        cutoffValue: '{{for}} orders close {{closes}} {{time}}',
      ...
      myJobs: {
        ...
        markAwarded: 'Mark as awarded',
        closeJob: 'Close job',
        reopen: 'Reopen',
        toastClosed: 'Job closed. Businesses can no longer apply.',
        toastAwarded: 'Marked as awarded. It stays on your list and leaves the board.',
      ...
      pageDesign: {
        ...
        optional: '(optional)',
        preset_quiet: 'Understated',
        preset_warm: 'Warm',
        preset_bold: 'Bold',
        preset_plain: 'Straightforward',
        dial_type: 'Lettering',
        dial_density: 'Spacing',
        dial_imagery: 'Photos',
        dial_price_prominence: 'Prices',
        dial_motion: 'Movement',
        dialValue_type_serif: 'Classic',
        dialValue_type_grotesque: 'Strong',
        dialValue_type_geometric: 'Plain',
        dialValue_density_airy: 'Roomy',
        dialValue_density_balanced: 'Even',
        dialValue_density_packed: 'Compact',
        'dialValue_imagery_full-bleed': 'Large',
        dialValue_imagery_grid: 'Square',
        dialValue_imagery_thumbnail: 'Small',
        dialValue_price_prominence_quiet: 'Discreet',
        dialValue_price_prominence_normal: 'Clear',
        dialValue_price_prominence_loud: 'Front and centre',
        dialValue_motion_still: 'None',
        dialValue_motion_subtle: 'Gentle',
        dialYours: 'yours',
        changed: 'Changed:',
        brief: 'A few questions',
        briefProgress: '{{done}} of {{total}} answered',
        briefHint: 'Skip anything you like. Your page already works without these, and answering just moves the settings below for you.',
        q_showing: 'What are you showing people?',
        a_showing_services: 'A few services',
        a_showing_catalogue: 'A catalogue of products',
        'a_showing_one-thing': 'One main thing',
        a_showing_place: 'A place people visit',
        a_showing_properties: 'Properties',
        q_action: 'What should someone do when they land here?',
        a_action_message: 'Message me',
        a_action_book: 'Book a time',
        a_action_visit: 'Come to the shop',
        a_action_order: 'Order something',
        a_action_understand: 'Just understand what I do',
        q_audience: 'Who is it mostly for?',
        a_audience_locals: 'Locals nearby',
        a_audience_olim: 'English speakers and olim',
        a_audience_tourists: 'Tourists',
        a_audience_businesses: 'Other businesses',
        a_audience_everyone: 'Everyone',
        q_pricing: 'Where do your prices sit?',
        a_pricing_premium: 'Premium, and worth it',
        a_pricing_fair: 'Fair, middle of the road',
        a_pricing_value: 'Great value, keenly priced',
        a_pricing_quote: 'Depends on the job, I quote',
        q_strengths: 'What should people know first about you?',
        q_strengthsCap: '(up to two)',
        strength_quality: 'The quality of the work',
        strength_speed: 'How fast I am',
        strength_price: 'The price',
        strength_experience: 'Years of experience',
        strength_kosher: 'Kosher certification',
        strength_english: 'I speak English',
        strength_family: 'Family business',
        strength_licensed: 'Licensed and insured',
        q_look: 'Which of these feels closest?',
        q_note: 'Anything else you want people to know?',
        notePlaceholder: 'We have been on Emek Refaim since 1998 and everything is baked the same morning.',
        shelf: 'What comes first',
        shelfNoServices: 'Add a service or two, then you can choose what your page leads with and how it is grouped.',
        shelfNote: 'Your groups replace the automatic ones. Featured services show above them either way.',
        featured: 'Featured first',
        featuredHint: 'Up to three, shown at the top of your page. Your judgement about what sells beats any order we could invent.',
        featuredCount: '{{n}} of {{max}} chosen',
        collections: 'Groups',
        collectionsHint: 'Name a group and tick what belongs in it. A service can sit in more than one. Anything you do not group still shows, under "More from this business".',
        collectionName: 'Group name',
        collectionNamePh: 'e.g. Shabbos packages',
        collectionCount: '{{n}} in this group',
        collectionRemove: 'Remove group',
        collectionAdd: 'Add a group',
        collectionAddAnother: 'Add another group',
        collectionUp: 'Move group up',
        collectionDown: 'Move group down',
        collectionIncomplete: 'A group needs a name and at least one service, or it is not saved.',
      ...
      reviews: {
        title: 'Reviews',
        verifiedStays_one: '{{count}} verified stay',
        verifiedStays_other: '{{count}} verified stays',
        verifiedCustomers_one: '{{count}} verified customer',
        verifiedCustomers_other: '{{count}} verified customers',
        verifiedReviews_one: '{{count}} verified review',
        verifiedReviews_other: '{{count}} verified reviews',
        googleReviews_one: '{{count}} Google review',
        googleReviews_other: '{{count}} Google reviews',
        filterAll: 'All',
        ...
        badgeStay: 'Verified stay · {{when}}',
        badgeCustomer: 'Verified customer',
        badgeGoogle: 'From Google',
        edited: 'Edited',
        incentivized: 'The writer received something for this review',
        responseHost: 'Response from the host',
        responseBusiness: 'Response from the business',
        respond: 'Respond publicly',
        respondEdit: 'Edit your response',
        respondLabel: 'Your public response',
        respondPlaceholder: 'Your public response. Everyone who reads the review will see it.',
        respondSave: 'Post response',
        respondFailed: 'Your response did not save. Try again.',
        edit: 'Edit your review',
        editFailed: 'Your change did not save.',
        save: 'Save',
        cancel: 'Cancel',
        report: 'Report',
        reportSignIn: 'Sign in to report a review',
        reportTitle: 'Why are you reporting this review?',
        reportPick: 'Choose a reason',
        reportNote: 'Anything we should know (optional)',
        reportNotNegative: 'A review is not removed for being negative.',
        reportSend: 'Send report',
        reportThanks: "Thanks. We'll check it, and it stays up until we decide.",
        ...
        reason_hate_or_harassment: 'Hate or harassment',
        reason_personal_information: 'Shares personal information',
        reason_off_topic: 'Not about this place or service',
        reason_conflict_of_interest: 'Written by someone with a stake in it',
        reason_illegal_content: 'Illegal content',
        reason_deleted_at_source: 'Deleted on Google',
        reason_other: 'Something else',
        sub_cleanliness: 'Cleanliness',
        sub_accuracy: 'Accuracy',
        sub_communication: 'Communication',
        sub_location: 'Location',
        sub_value: 'Value',
      },
      reviewForm: {
        metaTitle: 'Write a review',
        titleStay: 'How was your stay?',
        titleService: 'How did it go?',
        dateRange: '{{from}} to {{to}}',
        starsN_one: '{{count}} star',
        starsN_other: '{{count}} stars',
        overall: 'Overall',
        details: 'In detail (optional)',
        textLabel: 'Your review',
        textHint: 'What should the next person know? Good or bad, say what happened.',
        moreChars_one: '{{count}} more character',
        moreChars_other: '{{count}} more characters',
        publicNote: 'Your first name and last initial appear with your review, marked as a verified booking.',
        submit: 'Post review',
        pickStars: 'Choose a star rating.',
        tooShort: 'Write at least {{n}} characters.',
        failed: 'Your review did not send. Try again.',
        thanks: 'Thank you. Your review is up.',
        editWindow: 'You can change it for the next 48 hours from the listing page.',
        seeIt: 'See it on the page',
        closedTitle: "This review can't be written",
        signIn: 'Sign in',
        reason_sign_in: 'Sign in with the account you booked with.',
        reason_off: 'Reviews are not open yet.',
        reason_error: 'Something went wrong. Try the link again later.',
        reason_not_found: "We can't find this booking.",
        reason_not_yours: 'This booking belongs to another account.',
        reason_own_listing: "You can't review your own listing or business.",
        reason_not_completed: 'Reviews open once the booking is completed.',
        reason_cancelled: 'This booking was cancelled.',
        reason_too_early: 'Reviews open the day after checkout.',
        reason_window_closed: 'Reviews close 30 days after the booking ends.',
        reason_already_reviewed: 'This booking already has a review.',
        reason_link_used: 'This link has already been used.',
        reason_link_expired: 'This link has expired.',
        reason_link_invalid: 'This link is not valid.',
        reason_text_too_short: 'Write at least 20 characters.',
        reason_bad_rating: 'Choose between 1 and 5 stars.',
      },
      adminReviews: {
        off: 'Verified reviews are switched off.',
        empty: 'No reported reviews waiting.',
        loadFailed: 'Could not load reported reviews',
        rule: 'Remove only for a listed reason. A review is never removed for being negative. Each decision is logged.',
        open: 'Open page',
        reported: 'Reported:',
        keep: 'Keep it up',
        reasonLabel: 'Reason for removal',
        pickReason: 'Reason for removal',
        remove: 'Remove',
        kept: 'Kept on the page',
        removed: 'Removed',
        failed: 'That did not work',
      },
      googleReviews: {
        title: 'Your Google reviews',
        pitch: 'Show the reviews from your Google Business Profile on your pages here. All of them come in, good and bad, marked "From Google".',
        connect: 'Connect Google reviews',
        notReady: 'Connecting Google is not available yet.',
        connected: 'Google is connected. Now match each place to your listing.',
        failed: 'Google did not connect. Try again.',
        cancelled: 'Google was not connected. You can try again any time.',
        loading: 'Looking up your Google places...',
        match: 'Match each Google place to the page its reviews belong on.',
        none: 'This Google account manages no business places.',
        showOn: 'Show reviews of {{place}} on',
        dontShow: "Don't show",
        kindBusiness: 'Business page',
        kindProperty: 'Rental',
        kindService: 'Service',
        save: 'Save',
        saved: 'Saved. Your Google reviews will appear within a few minutes.',
      ...
      upgrade: {
        ...
        nationwide: 'All of Israel',
        from: 'from {{price}}',
        order: 'Order now',
        book: 'Book',
        message: 'Message',
        seeAll: 'See everything they offer',
        seeReviews: 'Read the reviews',
        whyAsk: 'Ask anything before you decide. Replies come in the chat.',
        strength_quality: 'Quality work',
        strength_speed: 'Fast',
        strength_price: 'Good prices',
        strength_experience: 'Experienced',
        strength_kosher: 'Kosher certified',
        strength_english: 'Speaks English',
        strength_family: 'Family business',
        strength_licensed: 'Licensed and insured',
        bedrooms_one: '1 bedroom',
        bedrooms_other: '{{count}} bedrooms',
        bathrooms_one: '1 bathroom',
        bathrooms_other: '{{count}} bathrooms',
        thePlace: 'The place',
        propertyWhy: 'Book directly with the owner. No booking fees.',
        askOwner: 'Ask the owner a question',
      },
      proof: {
        verified: 'Verified',
      ...
      wizard: {
        type_store: 'Store',
        type_store_tagline: 'Showcase products for sale',
        type_store_examples: 'Furniture store, boutique, gift shop, jewelry',
        type_deliverable: 'Deliverable service',
        type_deliverable_tagline: 'Priced work with a turnaround time',
        type_deliverable_examples: 'Logo design, translation, cleaning, moving, video editing',
        type_appointment: 'Appointment service',
        type_appointment_tagline: 'Book a specific day and time',
        type_appointment_examples: 'Barber, salon, massage, personal trainer, tutor',
        examples: 'Examples:',
        typeIntro: 'Choose the type of listing that best fits your business. This changes what we ask next, so we only ask what is relevant.',
        title: 'Title',
        titlePhStore: 'e.g. Modern furniture, Tel Aviv showroom',
        titlePh: 'e.g. Deep apartment cleaning',
        category: 'Category',
        descriptionPh: 'Describe what you offer, who it is for, and what is included…',
        descriptionHint: 'At least 10 characters. It is translated automatically, so write it once, in either language.',
        reachStore: 'How should buyers reach you?',
        reachService: 'How should clients book?',
        modeWaStore: 'Message on WhatsApp',
        modeWa: 'Book on WhatsApp',
        modeSiteStore: 'Message on MyIsraelRental',
        modeSite: 'Book on MyIsraelRental',
        area: 'Service area',
        areaPh: 'Tel Aviv, Jerusalem, Haifa…',
        areaHint: 'Pick a city so people nearby can find you with',
        back: 'Back',
        next: 'Next',
        publishing: 'Publishing…',
        publish: 'Publish',
        reasonType: 'Pick a listing type to continue.',
        reasonTitle: 'Add a title above.',
        reasonCategory: 'Pick a category above.',
        reasonDescription: 'Write at least 10 characters describing what you offer.',
        reasonProductName: 'Give every product a name.',
        reasonProductPrice: 'Every product needs a price greater than 0.',
        reasonTierPrice: 'Every service needs a price greater than 0.',
        reasonHours: 'Turn on at least one open day so customers can book you.',
        reasonArea: 'Pick a service area (city).',
        reasonTierName: 'Give every service a name (see the highlighted field).',
        maxPhotos: 'Up to 6 photos per option',
        uploadFailed: 'Upload failed',
        someFailed_one: '1 photo did not upload',
        someFailed_other: '{{count}} photos did not upload',
        publishFailed: 'Could not publish. Please try again.',
        dismiss: 'Dismiss',
        welcomeEyebrow: 'Welcome aboard',
        welcomeTitle: 'Let us create your first listing',
        welcomeBody: 'Tell us what you offer. Customers see your listing as soon as you publish it.',
        metaTitle: 'Add your business | MyIsraelRental',
        metaDescription: 'List your business on MyIsraelRental, free.',
        productsIntro: 'Add each product you sell as its own row, with photos, a price and a short description. Customers browse them and message you to buy.',
        removePhoto: 'Remove photo',
        productNamePh: 'Product name (e.g. Oak dining table)',
        productDescPh: 'Short description (optional): size, materials, colours…',
        addProduct: 'Add another product',
        tiersIntroAppt: 'List each service people can book. A barber might add Haircut (30 min · ₪60), Beard trim (15 min · ₪30) and Full grooming (45 min · ₪90). The length is what builds your booking times.',
        tiersIntro: 'List each service or package as its own option. A designer might add Basic (3 samples · 3 days · ₪250) and Premium (5 samples · 5 days · ₪450).',
        serviceName: 'Service name',
        tierName: 'Service or package name',
        serviceNamePhAppt: 'e.g. Haircut',
        serviceNamePh: 'e.g. Basic package',
        min: 'min',
        daysTitle: 'Turnaround in days. Leave blank for on-the-spot services.',
        durationHint: 'is how long this service takes. It builds your booking times.',
        daysHint: 'is the turnaround time. Leave blank for on-the-spot services.',
        includedPh: 'What is included (optional)',
        tierNeedBoth: 'Add a service name and a price above to continue.',
        tierNeedName: 'Give this service a name (e.g. Haircut, Deep clean).',
        tierNeedPrice: 'Add a price greater than 0.',
        addTier: 'Add another service',
        dateBooking: 'Let customers pick a service date',
        dateBookingHint: 'Best for cleaners, movers, plumbers, or anyone whose customer needs to fix the day the work happens. If off, customers describe what they need in a message.',
        hoursIntro: 'Tell us when you are open. We turn this into booking times on your page. You can change it or add exceptions later from your dashboard.',
        day_mon: 'Mon',
        day_tue: 'Tue',
        day_wed: 'Wed',
        day_thu: 'Thu',
      ...
      guide: {
        metaTitle: 'How this site grows your business',
        kicker: 'Getting started',
        title: 'How this site grows your business',
        intro: 'One thing at a time, in the order most people use them. Each one takes a few minutes to set up and keeps working after that.',
        for_business: 'I run a business',
        for_host: 'I rent out a place',
        progress: 'Progress',
        stepOf: 'Step {{n}} of {{total}}',
        howItHelps: 'How it helps you grow:',
        setUp: 'Set this up',
      ...
      features: {
        ...
        item: {
          ...
          'work-with-other-businesses': {
            title: 'Work with other businesses, not just customers',
            benefit: 'Connect with your suppliers, your courier and the businesses you send work to.',
            body: 'Every business page has a Connect button. Once two businesses are connected, orders can pass between them without anyone retyping them, and you can message each other from the dashboard. A bakery and its courier, a host and a cleaner, a caterer and a florist: the jobs you pass along every week stop living in a WhatsApp thread.',
            forWho: 'Any business that buys from, sells to or works alongside another one.',
            cta: 'Open my network',
          },
          'hand-off-the-repeat-work': {
            title: 'Let the repeat work run itself',
            benefit: 'When this happens, do that: in one sentence, in your words.',
            body: 'When an order is ready, it goes to your courier. When guests book, your cleaner gets the job, timed for checkout, and loses it again if the stay is cancelled. When someone books, they get a thank-you. Every Sunday morning, your usual order goes to your supplier. You are told when a supplier changes a price, and when a business nearby is cheaper or running a deal.',
            forWho: 'Businesses and hosts who do the same thing every week.',
            cta: 'Set up an automation',
          },
        },
      },
      setup: {
        ...
        item: {
          ...
          biz_automation: 'Set up your first automation',
        },
        why: {
          ...
          biz_automation: 'Let the site do the repeat jobs: tell you when a customer taps to message, thank people who book, reorder from your supplier every week.',
        },
      },
      tips: {
      ...
      help: {
        ...
        growthGuide: 'How this grows your business',
      },
      businesses: {
        ...
        // The owner-chosen address (components/dashboard/WebAddressField.jsx).
        webAddress: {
          title: 'Your web address',
          inputAria: 'Web address',
          current: 'This is your address now.',
          checking: 'Checking…',
          available: 'Available',
          taken: 'Another business already uses this address.',
          reserved: 'This address is reserved for the site. Try another.',
          invalid: 'Use lowercase English letters, numbers and hyphens, not at the start or end.',
          error: 'Could not check right now.',
          use: 'Use this address',
          saved: 'Your web address is now {{address}}',
          saveFailed: 'Could not change the address.',
          pickMemorable: 'Pick an address people can remember and type.',
          hint: 'Your old address keeps working, so anything you have already shared or printed still opens your page.',
        },
      ...
      sign: {
        ...
        contractEyebrow: 'Rental Contract',
      ...
      admin: {
        pageUpgradeOn: 'Page upgrade on',
        pageUpgradeOff: 'Page upgrade off',
        pageUpgradeFailed: 'Could not change the page upgrade',
        pageUpgradeHint: "Paid page upgrade for all of this person's pages",
        pageUpgradeOnShort: 'Upgrade on',
        pageUpgradeOffShort: 'Upgrade',
        groupSupply: 'Supply',
        groupDemand: 'Demand',
        groupPeople: 'People',
        groupTools: 'Tools',
        ...
        kpiViews: 'Property views',
        kpiServiceViews: 'Service & business views',
        kpiWhatsappClicks: 'WhatsApp taps',
        kpiQrScans: 'QR scans',
        kpiSiteVisitors: 'Site visitors',
        kpiSitePageviews: 'Pages opened',
        siteSince: 'Site visitors counted since {{date}}',
        byPersonTitle: 'Demand by person',
        byPersonHint: 'Everything each person owns, added up: listings, services, business pages and requests.',
        byPersonSearch: 'Search by name or email',
        byPersonColPerson: 'Person',
        byPersonColVisitors: 'Visitors',
        byPersonFailed: 'These numbers could not be loaded.',
        byPersonEmpty: 'No taps, visitors or scans in this period.',
        byPersonNoMatch: 'Nobody matches that search.',
        byPersonDeleted: 'Account no longer exists',
        ...
        usersCount_one: '1 user',
        usersCount_other: '{{count}} users',
        listingsCount_one: '1 listing',
        listingsCount_other: '{{count}} listings',
        ...
        deleteUserDesc: 'Their properties, businesses, services, requests, saved searches and alerts go too. Bookings, contracts, orders, reviews and chats with other people are kept. You can restore the account from Recently deleted below.',
        userRestored_one: 'The account is back, with 1 of their records. They sign in with Google or use Forgot password.',
        userRestored_other: 'The account is back, with {{count}} of their records. They sign in with Google or use Forgot password.',
        userDeletedKept: 'Account deleted. Bookings, contracts, orders, reviews and chats with other people were kept.',
        userDeleted: 'User deleted',
        undo: 'Undo',
        restore: 'Restore',
        restoreFailed: 'Could not restore this account',
        recentlyDeleted: 'Recently deleted',
        recentlyDeletedDesc: 'Restoring brings back the account and everything that was only theirs. They sign in with Google or use Forgot password; uploaded contract files do not come back.',
      ...
      sweep: {
        ...
        smartListsIntro: 'Filter active rentals, tick the ones worth sending, and share a short list on WhatsApp, email or Telegram.',
        monthlyRentRange: 'Monthly rent (₪)',
        minShort: 'Min',
        maxShort: 'Max',
        priceOffForVacation: 'Price filter disabled for vacation rentals.',
        usdAutoConverted: 'USD listings auto-converted to ILS before filtering.',
        bedroomsRange: 'Bedrooms',
        minBedroomsAria: 'Minimum bedrooms',
        maxBedroomsAria: 'Maximum bedrooms',
        anyMin: 'Any',
        anyMax: 'Any',
        addedToSite: 'Added to site',
        addedToSiteHint: 'Listings without an added-on date are left out of a recent list.',
        copied: 'Copied',
        copySelected: 'Copy {{n}} selected',
        shareSelectedWhatsApp: 'Share {{n}} on WhatsApp',
        saveThisList: 'Save this list',
        matchedSelected: '{{n}} matched · {{sel}} selected',
        maxPerMessage: 'Max per message',
        noCap: 'No cap',
        ...
        listedWithin7: 'Last 7 days',
        listedWithin14: 'Last 14 days',
        listedWithin30: 'Last 30 days',
        sortNewest: 'Newest first',
        sortOldest: 'Oldest first',
        addedToday: 'Added today',
        addedYesterday: 'Added yesterday',
        addedDaysAgo: 'Added {{n}} days ago',
        capReached: "That's the {{n}}-listing cap. Untick one first, or raise the cap.",
        minRentOverMax: 'Minimum rent is higher than the maximum.',
        minBedsOverMax: 'Minimum bedrooms is higher than the maximum.',
        tooLongForWhatsApp: 'Too long for one WhatsApp message ({{used}} of {{max}} characters). Untick a few listings and try again.',
        // Admin Duplicates
      ...
      settings: {
        ...
        autoNudgeOnLabel: 'On, remind me after 12 hours',
        autoNudgeOffLabel: 'Off, no automatic reminders',
      ...
      automations: {
        intro: 'One sentence, in your words: when this happens, do that. Hand a job to a partner, get told, or message the customer, without retyping anything.',
        none: 'No automations yet.',
        new: 'New automation',
        needPartner: 'Connect with a business first. Automations send orders to a partner.',
        aPartner: 'a partner',
        partner: 'Partner',
        choose: 'Choose…',
        name: 'Name',
        namePlaceholder: 'Send deliveries to Dan',
        when: 'When',
        whenStatus: 'When one of my orders is {{status}}',
        whenManual: 'When you tap Send',
        orderFor: 'order for {{name}}',
        copy: 'Send that order as it is (the delivery IS the order)',
        items: 'What to order',
        fulfilment: 'Pickup or delivery',
        address: 'Address',
        notes: 'Note for them (optional)',
        ...
        confirmDelete: 'Delete "{{name}}"? Orders it already made stay.',
        ranCount_one: 'Ran once',
        ranCount_other: 'Ran {{count}} times',
        neverRan: 'Has not run yet',
        paused: 'Paused: you are no longer connected',
        pickPartner: 'Pick a partner business',
        nameIt: 'Give this automation a name',
        sayWhat: 'Say what to order',
        needAddress: 'A delivery needs an address',
        loadFailed: 'Your automations could not be loaded.',
        autoAcceptTitle: 'Orders you accept automatically',
        autoAcceptBody: 'Their automated orders skip the waiting step and start on your board. Leave a limit empty for no limit.',
        maxAmount: 'Up to ₪',
        maxPerDay: 'a day, at most',
        runs: 'What automations did',
        noRuns: 'Nothing yet.',
        runSent: '{{name}} sent an order to {{to}}',
        runReceived: '{{from}} sent you an order',
        runAccepted: 'accepted automatically',
        runFailed: 'did not work',
        whenBooked: 'When an appointment is booked',
        whenCancelled: 'When an appointment is cancelled',
        whenLead: 'When a customer taps to message me',
        whenWeekly: 'Every week, on days I pick',
        whenSchedule: 'Every {{days}} at {{time}}',
        then: 'Then',
        doSendOrder: 'An order appears at a partner',
        doNotifyMe: 'Notify me',
        doMessageCustomer: 'Message the customer',
        doNotify: 'notify me',
        doMessage: 'message the customer',
        onDays: 'On',
        atTime: 'At',
        messageText: 'The message',
        messagePlaceholder: 'Thanks for booking, see you then!',
        notifyText: 'What to tell me (optional)',
        writeIt: 'Write the message',
        pickDays: 'Pick at least one day',
        next: 'Next: {{when}}',
        ran: 'Done',
        starters: 'Or start from one of these',
        needsPartner: 'Connect with a business first',
        recipe_courierReady: 'When an order is ready, send it to my courier',
        recipe_weeklyReorder: 'Every Sunday morning, reorder from my supplier',
        recipe_bookedThanks: 'When someone books, thank them',
        recipe_cancelledTellMe: 'When a booking is cancelled, tell me',
        recipe_leadTellMe: 'When a customer taps to message me, tell me',
        recipe_doneThanks: 'When an order is done, thank the customer',
        bookedThanksText: 'Thanks for booking! See you then.',
        doneThanksText: 'Thank you for your order. Hope to see you again soon.',
        runNotified: '{{name}} told you',
        runMessaged: '{{name}} messaged the customer',
        runSkipped: '{{name}} did nothing',
        whenStay: 'When guests book {{where}}',
        whenStayCancelled: 'When guests cancel {{where}}',
        whenStayOption: 'When guests book one of my listings',
        whenStayCancelledOption: 'When guests cancel a stay',
        atListing: 'at {{title}}',
        aListing: 'one of my listings',
        anyListing: 'at any of my listings',
        whichListing: 'Which listing',
        allListings: 'All my listings',
        addressFromListing: 'Leave empty: the listing\'s address is used',
        total: 'Price, ₪ (optional)',
        stayTiming: 'The job is due when the guests leave, and says when the next guests arrive. Guest names and phone numbers are never passed on.',
        recipe_cleaningBetweenGuests: 'When guests book, send the cleaning to my cleaner',
        recipe_checkInDetails: 'When guests book, send them check-in details',
        cleaningItems: 'Cleaning between guests: full clean, change linen and towels',
        checkInDetailsText: 'Your stay is confirmed! Check-in is from 15:00. Write to me here with any question.',
        pricesTitle: 'Prices',
      ...
      network: {
        title: 'Your network',
        subtitle: 'Businesses you work with: suppliers, couriers and partners.',
        actingAs: 'As',
        view_partners: 'Partners',
        view_requests: 'Requests',
        view_automations: 'Automations',
        view_find: 'Find partners',
        loadFailed: 'Your network could not be loaded.',
        retry: 'Try again',
        loading: 'Loading…',
        noPartners: 'No partners yet.',
        findSome: 'Find businesses to work with',
        waitingOnYou: 'Waiting on you',
        noneIncoming: 'Nothing waiting.',
        youAsked: 'You asked',
        noneOutgoing: 'No requests sent.',
        accept: 'Accept',
        decline: 'Decline',
        withdraw: 'Withdraw',
        disconnect: 'Disconnect',
        message: 'Message',
        findKind: 'What kind of business?',
        findAllKinds: 'All kinds',
        findName: 'Name',
        findNamePh: 'Search by name',
        findFailed: 'Businesses could not be loaded.',
        findNone: 'No businesses match. Try another kind or name.',
        requestSent: 'Request sent',
        browse: 'Browse businesses',
        needBusiness: 'Add your business, free, to connect with other businesses.',
        ...
        notePh: 'For example: we are looking for a courier for Friday deliveries.',
        send: 'Send request',
        cancel: 'Cancel',
      },
