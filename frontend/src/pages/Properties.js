...
const StepperControl = ({ label, value, onDecrement, onIncrement, displayValue, testId }) => (
  <div className="flex items-center justify-between py-3">
    ...
    <div className="flex items-center gap-2.5">
      ...
      <span className="w-7 text-center text-[14px] font-semibold text-[#4A90D9] tabular-nums" data-testid={`${testId}-value`}>
        {displayValue}
      </span>
      <button
        onClick={onIncrement}
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        <div className="flex items-center justify-between mb-8">
          ...
          <button
            ...
            style={{ 
              backgroundColor: showFilters ? '#4A90D9' : '#fafaf8', 
              color: showFilters ? '#D4AF37' : '#4A90D9',
              border: showFilters ? '1.5px solid #4A90D9' : '1.5px solid #e0dcd4'
            }}
          ...
          >
            ...
            {t('filters.filters')}
            {activeFilterCount > 0 && (
              <span className="w-5 h-5 rounded-full text-[10px] flex items-center justify-center font-bold bg-[#D4AF37] text-[#4A90D9]">
                {activeFilterCount}
              </span>
            )}
          </button>
        ...
        {showFilters && (
          <div className="mb-8 rounded-2xl overflow-hidden" style={{ border: '1px solid #e0dcd4', boxShadow: '0 8px 40px rgba(0,0,0,0.08), 0 1px 3px rgba(0,0,0,0.04)' }} data-testid="filters-panel">
            {/* Header */}
            <div className="px-7 py-4 flex items-center justify-between" style={{ background: 'linear-gradient(135deg, #4A90D9 0%, #5EA3E8 100%)' }}>
              <div className="flex items-center gap-2.5">
                ...
                {activeFilterCount > 0 && (
                  <span className="ml-1 w-5 h-5 rounded-full text-[10px] flex items-center justify-center font-bold bg-[#D4AF37] text-[#4A90D9]">
                    {activeFilterCount}
                  </span>
                )}
              </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2">
                ...
                <div className="lg:border-r" style={{ borderColor: '#e8e4dc' }}>
                  ...
                  <div className="px-7 pt-6 pb-5" data-testid="filter-price-section">
                    <div className="flex items-center justify-between mb-1">
                      <h3 className="text-[13px] font-bold tracking-[0.06em] uppercase text-[#4A90D9]">{t('filters.priceRange')}</h3>
                      <div className="flex rounded-lg overflow-hidden" style={{ border: '1.5px solid #d0ccc4' }} data-testid="filter-currency-toggle">
                        <button
                          ...
                          className={`px-3 py-1 text-xs font-bold tracking-wider transition-all duration-200 ${priceCurrency === 'ILS' ? 'bg-[#4A90D9] text-[#D4AF37]' : 'bg-transparent text-[#999] hover:text-[#666]'}`}
                        ...
                        <button
                          ...
                          className={`px-3 py-1 text-xs font-bold tracking-wider transition-all duration-200 ${priceCurrency === 'USD' ? 'bg-[#4A90D9] text-[#D4AF37]' : 'bg-transparent text-[#999] hover:text-[#666]'}`}
                    ...
                    <div className="px-1 mb-5">
                      <Slider
                        ...
                        max={PRICE_MAX}
                        step={100}
                        className="[&_[role=slider]]:h-5 [&_[role=slider]]:w-5 [&_[role=slider]]:border-[2.5px] [&_[role=slider]]:border-[#4A90D9] [&_[role=slider]]:bg-white [&_[role=slider]]:shadow-md [&_[role=slider]]:hover:shadow-lg [&_[role=slider]]:hover:scale-110 [&_[role=slider]]:transition-all [&_.bg-primary\\/20]:bg-[#e0dcd4] [&_.bg-primary\\/20]:h-[3px] [&_.bg-primary]:bg-[#D4AF37] [&_.bg-primary]:h-[3px]"
                      ...
                      <div className="flex-1">
                        ...
                        <div className="flex items-center rounded-lg px-3.5 py-2.5 bg-white transition-all duration-200 hover:shadow-sm" style={{ border: '1.5px solid #e0dcd4' }}>
                          ...
                          <input
                            ...
                            placeholder="0"
                            className="w-full text-sm font-medium bg-transparent outline-none text-[#4A90D9] placeholder:text-[#ccc]"
                  ...
                  <div className="px-7 py-5" data-testid="filter-rooms-section">
                    <h3 className="text-[13px] font-bold tracking-[0.06em] uppercase text-[#4A90D9] mb-1">{t('filters.roomsAndDetails')}</h3>
                ...
                <div>
                  ...
                  <div className="px-7 pt-6 pb-5" data-testid="filter-property-section">
                    <h3 className="text-[13px] font-bold tracking-[0.06em] uppercase text-[#4A90D9] mb-4">{t('filters.propertySection')}</h3>
                    ...
                    <div className="space-y-4">
                      ...
                      <div>
                        ...
                        <select
                          ...
                          className="w-full px-3.5 py-2.5 rounded-lg text-sm bg-white focus:outline-none focus:shadow-sm transition-all duration-200 text-[#4A90D9] appearance-none"
                  ...
                  <div className="px-7 py-5" data-testid="filter-dates-section">
                    <h3 className="text-[13px] font-bold tracking-[0.06em] uppercase text-[#4A90D9] mb-3">{t('filters.datesAvailable')}</h3>
                    <Popover>
                      <PopoverTrigger asChild>
                        ...
                        >
                          ...
                          {dateRange.from ? (
                            <span className="text-[#4A90D9] font-medium text-[13px]">
                      ...
                      >
                        <div className="px-4 py-3 flex items-center justify-between" style={{ background: 'linear-gradient(135deg, #4A90D9 0%, #5EA3E8 100%)' }}>
                        ...
                        <Calendar
                          ...
                          classNames={{
                            ...
                            caption_label: "text-sm font-bold text-[#4A90D9]",
                            ...
                            day_range_start: "day-range-start bg-[#4A90D9] text-white hover:bg-[#4A90D9] rounded-l-md",
                            day_range_end: "day-range-end bg-[#4A90D9] text-white hover:bg-[#4A90D9] rounded-r-md",
                            day_selected: "bg-[#4A90D9] text-white hover:bg-[#4A90D9] focus:bg-[#4A90D9] focus:text-white",
                            ...
                            day_range_middle: "aria-selected:bg-[#D4AF37]/10 aria-selected:text-[#4A90D9]",
            ...
            <div className="px-7 py-4 flex items-center justify-between" style={{ background: 'linear-gradient(135deg, #4A90D9 0%, #5EA3E8 100%)' }}>
              ...
              <button
                ...
                className="px-7 py-2.5 rounded-lg text-[13px] font-bold tracking-wide text-[#4A90D9] transition-all duration-200 hover:shadow-lg hover:scale-[1.02] active:scale-[0.98]"
