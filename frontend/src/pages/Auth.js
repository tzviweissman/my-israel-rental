            ...
            {mode === 'signup' && (
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 rounded-lg border border-[#E5E5E5] focus:outline-none focus:ring-2 focus:ring-[#011B3C]/50"
                  required
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full px-4 py-3 pr-12 rounded-lg border border-[#E5E5E5] focus:outline-none focus:ring-2 focus:ring-[#011B3C]/50"
                  required
                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      className={`w-full px-4 py-3 pr-12 rounded-lg border focus:outline-none focus:ring-2 focus:ring-[#011B3C]/50 ${confirmPassword && confirmPassword !== formData.password ? 'border-red-400' : 'border-[#E5E5E5]'}`}
                      required
          ...
          <div className="mt-6 text-center">
            {mode === 'login' ? (
              <p className="text-sm text-gray-600">
                {t('auth.noAccount')}{' '}
                <a href="/auth/signup" className="font-medium" style={{ color: '#011B3C' }} data-testid="auth-toggle-link">
                  {t('auth.signUpHere')}
                </a>
              </p>
            ) : (
              <p className="text-sm text-gray-600">
                {t('auth.haveAccount')}{' '}
                <a href="/auth/login" className="font-medium" style={{ color: '#011B3C' }} data-testid="auth-toggle-link">
                  {t('auth.loginHere')}
                </a>
              </p>
            )}
