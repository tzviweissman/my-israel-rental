/**
 * CoverflowCarousel — a ring of cards raked back in 3D, draggable, looping.
 *
...
/**
 * @typedef {Object} CoverflowSlide
 * @property {string} src
 * @property {string} alt
 * @property {string} [title]
 * @property {string} [subtitle]
 * @property {{label: string, value: string}[]} [meta]
 */

/**
 * @param {Object} props
 * @param {CoverflowSlide[]} props.slides
 * @param {number} [props.rotate=44] Degrees the first neighbour tilts.
 * @param {number} [props.depth=0.6] How far the first neighbour recedes, as a fraction of card width.
 * @param {number} [props.perspective=3] Viewer distance as a multiple of card width — smaller is a wider lens.
 * @param {number} [props.falloff=0.56] Exponent on distance. Below 1 the rake eases off as cards travel out.
 * @param {number} [props.fade=0.1] Opacity lost per step from the centre.
 ...
 * @param {string} [props.label] Names the carousel for assistive tech.
 * @param {(index: number) => void} [props.onSelect] Fired when the centre card changes.
