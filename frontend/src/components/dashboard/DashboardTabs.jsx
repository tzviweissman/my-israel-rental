...
import { Layers, KeyRound, Home, Sparkles, Bell, Heart, MessageCircle, CalendarClock } from 'lucide-react';
      ...
      >
        ...
        {isOwnerLike && (
          <button
            ...
            className={`${cls(activeTab === 'availability')} flex items-center justify-center gap-1.5`}
