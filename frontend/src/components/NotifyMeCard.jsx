...
const NotifyMeCard = ({ filters, dateRange }) => {
  ...
  return (
    <div
      ...
      style={{
        background: 'linear-gradient(135deg, #1E6A6A 0%, #2A8585 100%)',
        boxShadow: '0 20px 50px rgba(30,106,106,0.25)',
      }}
    ...
    >
      ...
      <button
        onClick={handleSave}
        disabled={saving}
        className="inline-flex items-center gap-2 px-6 py-3 rounded-xl text-sm font-bold tracking-wide text-[#1E6A6A] transition-all duration-200 hover:shadow-xl hover:scale-[1.02] active:scale-[0.98] disabled:opacity-60"
