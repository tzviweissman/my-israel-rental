...
- **Not built:** the Meta WhatsApp template for "new delivery assigned" (a calendar item, not code), and the assistant's use of cutoffs (the assistant itself is not built).
